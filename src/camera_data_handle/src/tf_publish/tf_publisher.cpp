...
camera::TF_Publisher::TF_Publisher()
    : Node("TF_publish"), height_(1.5), tf2_reflash_(0), tf2_reflash_num_(0) {
...
void camera::TF_Publisher::position_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg) {
...
void camera::TF_Publisher::publish_transform() {
    if (!transform_initialized) {
        ...
        header_frame_id = "camera_color_frame";
        child_frame_id = "openmv_target_position";
...
void camera::TF_Publisher::initialize_transform(geometry_msgs::msg::TransformStamped &msg_loader,
